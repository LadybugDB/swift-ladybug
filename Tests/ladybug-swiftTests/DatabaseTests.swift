...
final class DatabaseTests: XCTestCase {
    func testOpenDatabaseWithDefaultConfig() throws {
        let dbPath =
            NSTemporaryDirectory() + "ladybug_swift_test_db_" + UUID().uuidString
    ...
    func testGetStorageVersion() {
        let version = Database.storageVersion
        XCTAssertGreaterThan(version, UInt64(0))
    }
