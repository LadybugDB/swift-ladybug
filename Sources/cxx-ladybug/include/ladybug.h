...
#ifdef __cplusplus
#define LADYBUG_C_API extern "C" LADYBUG_API
#else
#define LADYBUG_C_API LADYBUG_API
#endif
...
typedef struct {
    ...
    uint32_t thread_qos;
#endif
} ladybug_system_config;

/**
 * @brief ladybug_database manages all database components.
 */
typedef struct {
    void* _database;
} ladybug_database;
...
/**
 * @brief ladybug_connection is used to interact with a Database instance. Each connection is
...
/**
 * @brief ladybug_prepared_statement is a parameterized query which can avoid planning the same query
 * for repeated execution.
 */
typedef struct {
    void* _prepared_statement;
    void* _bound_values;
} ladybug_prepared_statement;

/**
 * @brief ladybug_query_result stores the result of a query.
 */
typedef struct {
    void* _query_result;
    bool _is_owned_by_cpp;
} ladybug_query_result;

/**
 * @brief ladybug_flat_tuple stores a vector of values.
 */
typedef struct {
    void* _flat_tuple;
    bool _is_owned_by_cpp;
...
/**
 * @brief ladybug_logical_type is the ladybug internal representation of data types.
 */
typedef struct {
    void* _data_type;
} ladybug_logical_type;

/**
 * @brief ladybug_value is used to represent a value with any ladybug internal dataType.
 */
typedef struct {
    void* _value;
    bool _is_owned_by_cpp;
...
/**
 * @brief ladybug internal internal_id type which stores the table_id and offset of a node/rel.
 */
typedef struct {
    uint64_t table_id;
    uint64_t offset;
} ladybug_internal_id_t;

/**
 * @brief ladybug internal date type which stores the number of days since 1970-01-01 00:00:00 UTC.
 */
typedef struct {
...
/**
 * @brief ladybug internal timestamp_ns type which stores the number of nanoseconds since 1970-01-01
 * 00:00:00 UTC.
 */
typedef struct {
    // Nanoseconds since 1970-01-01 00:00:00 UTC.
    int64_t value;
} ladybug_timestamp_ns_t;

/**
 * @brief ladybug internal timestamp_ms type which stores the number of milliseconds since 1970-01-01
 * 00:00:00 UTC.
 */
typedef struct {
    // Milliseconds since 1970-01-01 00:00:00 UTC.
    int64_t value;
} ladybug_timestamp_ms_t;

/**
 * @brief ladybug internal timestamp_sec_t type which stores the number of seconds since 1970-01-01
 * 00:00:00 UTC.
 */
typedef struct {
    // Seconds since 1970-01-01 00:00:00 UTC.
    int64_t value;
} ladybug_timestamp_sec_t;

/**
 * @brief ladybug internal timestamp_tz type which stores the number of microseconds since 1970-01-01
 * with timezone 00:00:00 UTC.
 */
typedef struct {
    // Microseconds since 1970-01-01 00:00:00 UTC.
    int64_t value;
} ladybug_timestamp_tz_t;

/**
 * @brief ladybug internal timestamp type which stores the number of microseconds since 1970-01-01
 * 00:00:00 UTC.
 */
typedef struct {
    // Microseconds since 1970-01-01 00:00:00 UTC.
...
/**
 * @brief ladybug internal interval type which stores the months, days and microseconds.
 */
typedef struct {
    int32_t months;
    int32_t days;
...
/**
 * @brief ladybug_query_summary stores the execution time, plan, compiling time and query options of a
 * query.
 */
typedef struct {
    void* _query_summary;
} ladybug_query_summary;
...
/**
 * @brief enum class for ladybug internal dataTypes.
 */
typedef enum {
    LADYBUG_ANY = 0,
    LADYBUG_NODE = 10,
    LADYBUG_REL = 11,
    LADYBUG_RECURSIVE_REL = 12,
    ...
    LADYBUG_FLOAT = 33,
    LADYBUG_DATE = 34,
    LADYBUG_TIMESTAMP = 35,
    LADYBUG_TIMESTAMP_SEC = 36,
    LADYBUG_TIMESTAMP_MS = 37,
    LADYBUG_TIMESTAMP_NS = 38,
    LADYBUG_TIMESTAMP_TZ = 39,
    LADYBUG_INTERVAL = 40,
    LADYBUG_DECIMAL = 41,
    LADYBUG_INTERNAL_ID = 42,
    // variable size types
    LADYBUG_STRING = 50,
    LADYBUG_BLOB = 51,
    LADYBUG_LIST = 52,
    ...
    LADYBUG_POINTER = 58,
    LADYBUG_UUID = 59
} ladybug_data_type_id;

/**
 * @brief enum class for ladybug function return state.
 */
typedef enum { LadybugSuccess = 0, LadybugError = 1 } ladybug_state;

// Database
/**
 * @brief Allocates memory and creates a ladybug database instance at database_path with
 * bufferPoolSize=buffer_pool_size. Caller is responsible for calling ladybug_database_destroy() to
 ...
 */
LADYBUG_C_API ladybug_state ladybug_database_init(const char* database_path,
    ladybug_system_config system_config, ladybug_database* out_database);
/**
 * @brief Destroys the ladybug database instance and frees the allocated memory.
 * @param database The database instance to destroy.
 */
LADYBUG_C_API void ladybug_database_destroy(ladybug_database* database);

LADYBUG_C_API ladybug_system_config ladybug_default_system_config();

// Connection
/**
 * @brief Allocates memory and creates a connection to the database. Caller is responsible for
 * calling ladybug_connection_destroy() to release the allocated memory.
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_connection_init(ladybug_database* database,
    ladybug_connection* out_connection);
/**
 * @brief Destroys the connection instance and frees the allocated memory.
 * @param connection The connection instance to destroy.
 */
LADYBUG_C_API void ladybug_connection_destroy(ladybug_connection* connection);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_connection_set_max_num_thread_for_exec(ladybug_connection* connection,
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_connection_get_max_num_thread_for_exec(ladybug_connection* connection,
    uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_connection_query(ladybug_connection* connection, const char* query,
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_connection_prepare(ladybug_connection* connection, const char* query,
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_connection_execute(ladybug_connection* connection,
    ladybug_prepared_statement* prepared_statement, ladybug_query_result* out_query_result);
/**
 * @brief Interrupts the current query execution in the connection.
 * @param connection The connection instance to interrupt.
 */
LADYBUG_C_API void ladybug_connection_interrupt(ladybug_connection* connection);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_connection_set_query_timeout(ladybug_connection* connection,
 ...
 */
LADYBUG_C_API void ladybug_prepared_statement_destroy(ladybug_prepared_statement* prepared_statement);
/**
 * @return the query is prepared successfully or not.
 */
LADYBUG_C_API bool ladybug_prepared_statement_is_success(ladybug_prepared_statement* prepared_statement);
/**
 * @brief Returns the error message if the prepared statement is not prepared successfully.
 * The caller is responsible for freeing the returned string with `ladybug_destroy_string`.
 ...
 */
LADYBUG_C_API char* ladybug_prepared_statement_get_error_message(
    ladybug_prepared_statement* prepared_statement);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_bool(ladybug_prepared_statement* prepared_statement,
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_int64(
    ladybug_prepared_statement* prepared_statement, const char* param_name, int64_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_int32(
    ladybug_prepared_statement* prepared_statement, const char* param_name, int32_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_int16(
    ladybug_prepared_statement* prepared_statement, const char* param_name, int16_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_int8(ladybug_prepared_statement* prepared_statement,
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_uint64(
    ladybug_prepared_statement* prepared_statement, const char* param_name, uint64_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_uint32(
    ladybug_prepared_statement* prepared_statement, const char* param_name, uint32_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_uint16(
    ladybug_prepared_statement* prepared_statement, const char* param_name, uint16_t value);
/**
 * @brief Binds the given int8_t value to the given parameter name in the prepared statement.
 * @param prepared_statement The prepared statement instance to bind the value.
 * @param param_name The parameter name to bind the value.
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_uint8(
    ladybug_prepared_statement* prepared_statement, const char* param_name, uint8_t value);
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_double(
    ladybug_prepared_statement* prepared_statement, const char* param_name, double value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_float(
    ladybug_prepared_statement* prepared_statement, const char* param_name, float value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_date(ladybug_prepared_statement* prepared_statement,
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_timestamp_ns(
    ladybug_prepared_statement* prepared_statement, const char* param_name, ladybug_timestamp_ns_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_timestamp_sec(
    ladybug_prepared_statement* prepared_statement, const char* param_name,
    ladybug_timestamp_sec_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_timestamp_tz(
    ladybug_prepared_statement* prepared_statement, const char* param_name, ladybug_timestamp_tz_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_timestamp_ms(
    ladybug_prepared_statement* prepared_statement, const char* param_name, ladybug_timestamp_ms_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_timestamp(
    ladybug_prepared_statement* prepared_statement, const char* param_name, ladybug_timestamp_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_interval(
    ladybug_prepared_statement* prepared_statement, const char* param_name, ladybug_interval_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_string(
    ladybug_prepared_statement* prepared_statement, const char* param_name, const char* value);
/**
 * @brief Binds the given ladybug value to the given parameter name in the prepared statement.
 * @param prepared_statement The prepared statement instance to bind the value.
 * @param param_name The parameter name to bind the value.
 * @param value The ladybug value to bind.
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_prepared_statement_bind_value(
    ladybug_prepared_statement* prepared_statement, const char* param_name, ladybug_value* value);
 ...
 */
LADYBUG_C_API void ladybug_query_result_destroy(ladybug_query_result* query_result);
/**
 ...
 */
LADYBUG_C_API bool ladybug_query_result_is_success(ladybug_query_result* query_result);
/**
 ...
 */
LADYBUG_C_API char* ladybug_query_result_get_error_message(ladybug_query_result* query_result);
/**
 * @brief Returns the number of columns in the query result.
 * @param query_result The query result instance to return.
 */
LADYBUG_C_API uint64_t ladybug_query_result_get_num_columns(ladybug_query_result* query_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_query_result_get_column_name(ladybug_query_result* query_result,
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_query_result_get_column_data_type(ladybug_query_result* query_result,
    uint64_t index, ladybug_logical_type* out_column_data_type);
/**
 * @brief Returns the number of tuples in the query result.
 * @param query_result The query result instance to return.
 */
LADYBUG_C_API uint64_t ladybug_query_result_get_num_tuples(ladybug_query_result* query_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_query_result_get_query_summary(ladybug_query_result* query_result,
 ...
 * @param query_result The query result instance to check.
 */
LADYBUG_C_API bool ladybug_query_result_has_next(ladybug_query_result* query_result);
/**
 * @brief Returns the next tuple in the query result. Throws an exception if there is no more tuple.
 * Note that to reduce resource allocation, all calls to ladybug_query_result_get_next() reuse the same
 * FlatTuple object. Since its contents will be overwritten, please complete processing a FlatTuple
 * or make a copy of its data before calling ladybug_query_result_get_next() again.
 * @param query_result The query result instance to return.
 * @param[out] out_flat_tuple The output parameter that will hold the next tuple.
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_query_result_get_next(ladybug_query_result* query_result,
 ...
 * @param query_result The query result instance to check.
 */
LADYBUG_C_API bool ladybug_query_result_has_next_query_result(ladybug_query_result* query_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_query_result_get_next_query_result(ladybug_query_result* query_result,
    ladybug_query_result* out_next_query_result);
 ...
 */
LADYBUG_C_API char* ladybug_query_result_to_string(ladybug_query_result* query_result);
/**
 ...
 */
LADYBUG_C_API void ladybug_query_result_reset_iterator(ladybug_query_result* query_result);
 ...
 */
LADYBUG_C_API ladybug_state ladybug_query_result_get_arrow_schema(ladybug_query_result* query_result,
 ...
 * It is the caller's responsibility to call the release function to release the underlying data
 */
LADYBUG_C_API ladybug_state ladybug_query_result_get_next_arrow_chunk(ladybug_query_result* query_result,
 ...
 */
LADYBUG_C_API void ladybug_flat_tuple_destroy(ladybug_flat_tuple* flat_tuple);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_flat_tuple_get_value(ladybug_flat_tuple* flat_tuple, uint64_t index,
 ...
 */
LADYBUG_C_API char* ladybug_flat_tuple_to_string(ladybug_flat_tuple* flat_tuple);
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API void ladybug_data_type_create(ladybug_data_type_id id, ladybug_logical_type* child_type,
    uint64_t num_elements_in_array, ladybug_logical_type* out_type);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API void ladybug_data_type_clone(ladybug_logical_type* data_type, ladybug_logical_type* out_type);
/**
 * @brief Destroys the given data type instance.
 * @param data_type The data type instance to destroy.
 */
LADYBUG_C_API void ladybug_data_type_destroy(ladybug_logical_type* data_type);
/**
 ...
 */
LADYBUG_C_API bool ladybug_data_type_equals(ladybug_logical_type* data_type1, ladybug_logical_type* data_type2);
/**
 * @brief Returns the enum type id of the given data type.
 * @param data_type The data type instance to return.
 */
LADYBUG_C_API ladybug_data_type_id ladybug_data_type_get_id(ladybug_logical_type* data_type);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_data_type_get_num_elements_in_array(ladybug_logical_type* data_type,
    uint64_t* out_result);
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_null();
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_null_with_data_type(ladybug_logical_type* data_type);
/**
 * @brief Returns true if the given value is NULL, false otherwise.
 * @param value The value instance to check.
 */
LADYBUG_C_API bool ladybug_value_is_null(ladybug_value* value);
/**
 ...
 */
LADYBUG_C_API void ladybug_value_set_null(ladybug_value* value, bool is_null);
/**
 ...
 * @param data_type The data type of the value to create.
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_default(ladybug_logical_type* data_type);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_bool(bool val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_int8(int8_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_int16(int16_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_int32(int32_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_int64(int64_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_uint8(uint8_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_uint16(uint16_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_uint32(uint32_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_uint64(uint64_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_int128(ladybug_int128_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_float(float val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_double(double val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_internal_id(ladybug_internal_id_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_date(ladybug_date_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_timestamp_ns(ladybug_timestamp_ns_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_timestamp_ms(ladybug_timestamp_ms_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_timestamp_sec(ladybug_timestamp_sec_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_timestamp_tz(ladybug_timestamp_tz_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_timestamp(ladybug_timestamp_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_interval(ladybug_interval_t val_);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_create_string(const char* val_);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_create_list(uint64_t num_elements, ladybug_value** elements,
    ladybug_value** out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_create_struct(uint64_t num_fields, const char** field_names,
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_create_map(uint64_t num_fields, ladybug_value** keys,
    ladybug_value** values, ladybug_value** out_value);
/**
 ...
 */
LADYBUG_C_API ladybug_value* ladybug_value_clone(ladybug_value* value);
/**
 * @brief Copies the other value to the value.
 * @param value The value to copy to.
 * @param other The value to copy from.
 */
LADYBUG_C_API void ladybug_value_copy(ladybug_value* value, ladybug_value* other);
/**
 * @brief Destroys the value.
 * @param value The value to destroy.
 */
LADYBUG_C_API void ladybug_value_destroy(ladybug_value* value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_list_size(ladybug_value* value, uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_list_element(ladybug_value* value, uint64_t index,
    ladybug_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_struct_num_fields(ladybug_value* value, uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_struct_field_name(ladybug_value* value, uint64_t index,
    char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_struct_field_value(ladybug_value* value, uint64_t index,
    ladybug_value* out_value);
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_map_size(ladybug_value* value, uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_map_key(ladybug_value* value, uint64_t index,
    ladybug_value* out_key);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_map_value(ladybug_value* value, uint64_t index,
    ladybug_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_recursive_rel_node_list(ladybug_value* value,
    ladybug_value* out_value);
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_recursive_rel_rel_list(ladybug_value* value,
    ladybug_value* out_value);
/**
 ...
 */
LADYBUG_C_API void ladybug_value_get_data_type(ladybug_value* value, ladybug_logical_type* out_type);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_bool(ladybug_value* value, bool* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_int8(ladybug_value* value, int8_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_int16(ladybug_value* value, int16_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_int32(ladybug_value* value, int32_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_int64(ladybug_value* value, int64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_uint8(ladybug_value* value, uint8_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_uint16(ladybug_value* value, uint16_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_uint32(ladybug_value* value, uint32_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_uint64(ladybug_value* value, uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_int128(ladybug_value* value, ladybug_int128_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_int128_t_from_string(const char* str, ladybug_int128_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_int128_t_to_string(ladybug_int128_t val, char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_float(ladybug_value* value, float* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_double(ladybug_value* value, double* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_internal_id(ladybug_value* value, ladybug_internal_id_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_date(ladybug_value* value, ladybug_date_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_timestamp(ladybug_value* value, ladybug_timestamp_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_timestamp_ns(ladybug_value* value,
    ladybug_timestamp_ns_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_timestamp_ms(ladybug_value* value,
    ladybug_timestamp_ms_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_timestamp_sec(ladybug_value* value,
    ladybug_timestamp_sec_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_timestamp_tz(ladybug_value* value,
    ladybug_timestamp_tz_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_interval(ladybug_value* value, ladybug_interval_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_decimal_as_string(ladybug_value* value, char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_string(ladybug_value* value, char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_blob(ladybug_value* value, uint8_t** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_value_get_uuid(ladybug_value* value, char** out_result);
/**
 * @brief Converts the given value to string.
 * @param value The value to convert.
 * @return The value as a string.
 */
LADYBUG_C_API char* ladybug_value_to_string(ladybug_value* value);
/**
 * @brief Returns the internal id value of the given node value as a ladybug value.
 * @param node_val The node value to return.
 * @param[out] out_value The output parameter that will hold the internal id value.
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_node_val_get_id_val(ladybug_value* node_val, ladybug_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_node_val_get_label_val(ladybug_value* node_val, ladybug_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_node_val_get_property_size(ladybug_value* node_val, uint64_t* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_node_val_get_property_name_at(ladybug_value* node_val, uint64_t index,
    char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_node_val_get_property_value_at(ladybug_value* node_val, uint64_t index,
    ladybug_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_node_val_to_string(ladybug_value* node_val, char** out_result);
/**
 * @brief Returns the internal id value of the rel value as a ladybug value.
 * @param rel_val The rel value to return.
 * @param[out] out_value The output parameter that will hold the internal id value.
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_rel_val_get_id_val(ladybug_value* rel_val, ladybug_value* out_value);
/**
 * @brief Returns the internal id value of the source node of the given rel value as a ladybug value.
 * @param rel_val The rel value to return.
 * @param[out] out_value The output parameter that will hold the internal id value.
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_rel_val_get_src_id_val(ladybug_value* rel_val, ladybug_value* out_value);
/**
 * @brief Returns the internal id value of the destination node of the given rel value as a ladybug
 * value.
 * @param rel_val The rel value to return.
 * @param[out] out_value The output parameter that will hold the internal id value.
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_rel_val_get_dst_id_val(ladybug_value* rel_val, ladybug_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_rel_val_get_label_val(ladybug_value* rel_val, ladybug_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_rel_val_get_property_size(ladybug_value* rel_val, uint64_t* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_rel_val_get_property_name_at(ladybug_value* rel_val, uint64_t index,
    char** out_result);
/**
 * @brief Returns the property of the given rel value at the given index as ladybug value.
 * @param rel_val The rel value to return.
 * @param index The index of the property.
 * @param[out] out_value The output parameter that will hold the property value at index.
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_rel_val_get_property_value_at(ladybug_value* rel_val, uint64_t index,
    ladybug_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_rel_val_to_string(ladybug_value* rel_val, char** out_result);
/**
 * @brief Destroys any string created by the Ladybug C API, including both the error message and the
 ...
 */
LADYBUG_C_API void ladybug_destroy_string(char* str);
/**
 * @brief Destroys any blob created by the Ladybug C API. This function is provided to avoid the
 ...
 */
LADYBUG_C_API void ladybug_destroy_blob(uint8_t* blob);
 ...
 */
LADYBUG_C_API void ladybug_query_summary_destroy(ladybug_query_summary* query_summary);
/**
 ...
 */
LADYBUG_C_API double ladybug_query_summary_get_compiling_time(ladybug_query_summary* query_summary);
/**
 ...
 */
LADYBUG_C_API double ladybug_query_summary_get_execution_time(ladybug_query_summary* query_summary);
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_ns_to_tm(ladybug_timestamp_ns_t timestamp, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_ms_to_tm(ladybug_timestamp_ms_t timestamp, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_sec_to_tm(ladybug_timestamp_sec_t timestamp,
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_tz_to_tm(ladybug_timestamp_tz_t timestamp, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_to_tm(ladybug_timestamp_t timestamp, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_ns_from_tm(struct tm tm, ladybug_timestamp_ns_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_ms_from_tm(struct tm tm, ladybug_timestamp_ms_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_sec_from_tm(struct tm tm, ladybug_timestamp_sec_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_tz_from_tm(struct tm tm, ladybug_timestamp_tz_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_timestamp_from_tm(struct tm tm, ladybug_timestamp_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_date_to_string(ladybug_date_t date, char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_date_from_string(const char* str, ladybug_date_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_date_to_tm(ladybug_date_t date, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
LADYBUG_C_API ladybug_state ladybug_date_from_tm(struct tm tm, ladybug_date_t* out_result);
/**
 ...
 */
LADYBUG_C_API void ladybug_interval_to_difftime(ladybug_interval_t interval, double* out_result);
/**
 * @brief Convert difftime value in seconds to interval.
 * @param difftime The difftime value to convert.
 * @param[out] out_result The output parameter that will hold the interval value.
 */
LADYBUG_C_API void ladybug_interval_from_difftime(double difftime, ladybug_interval_t* out_result);

// Version
/**
 * @brief Returns the version of the Ladybug library.
 */
LADYBUG_C_API char* ladybug_get_version();

/**
 * @brief Returns the storage version of the Ladybug library.
 */
LADYBUG_C_API uint64_t ladybug_get_storage_version();
#undef LADYBUG_C_API
