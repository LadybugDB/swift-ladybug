...
ParquetWriter::ParquetWriter(std::string fileName, std::vector<common::LogicalType> types,
    std::vector<std::string> columnNames, ladybug_parquet::format::CompressionCodec::type codec,
    ...
    ladybug_apache::thrift::protocol::TCompactProtocolFactoryT<ParquetWriterTransport> tprotoFactory;
    ...
    fileMetaData.schema[0].name = "ladybug_schema";
    fileMetaData.schema[0].num_children = this->types.size();
    fileMetaData.schema[0].__isset.num_children = true;
    fileMetaData.schema[0].repetition_type = ladybug_parquet::format::FieldRepetitionType::REQUIRED;
