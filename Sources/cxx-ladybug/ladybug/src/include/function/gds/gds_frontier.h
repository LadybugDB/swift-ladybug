...
class LADYBUG_API SparseFrontier : public Frontier {
...
class LADYBUG_API DenseFrontier : public Frontier {
...
class LADYBUG_API FrontierPair {
public:
...
class LADYBUG_API DenseSparseDynamicFrontierPair : public FrontierPair {
public:
...
class LADYBUG_API DenseFrontierPair : public FrontierPair {
public:
