...
LADYBUG_API int128_t operator+(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API int128_t operator-(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API int128_t operator*(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API int128_t operator/(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API int128_t operator%(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API int128_t operator^(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API int128_t operator&(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API int128_t operator~(const int128_t& val);
LADYBUG_API int128_t operator|(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API int128_t operator<<(const int128_t& lhs, int amount);
LADYBUG_API int128_t operator>>(const int128_t& lhs, int amount);

// comparison operators
LADYBUG_API bool operator==(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API bool operator!=(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API bool operator>(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API bool operator>=(const int128_t& lhs, const int128_t& rhs);
LADYBUG_API bool operator<(const int128_t& lhs, const int128_t& rhs);
...
template<>
struct std::hash<ladybug::common::int128_t> {
    std::size_t operator()(const ladybug::common::int128_t& v) const noexcept;
};
