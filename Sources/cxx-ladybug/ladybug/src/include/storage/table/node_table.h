...
struct LADYBUG_API NodeTableScanState : TableScanState {
...
struct LADYBUG_API NodeTableInsertState : public TableInsertState {
...
struct LADYBUG_API NodeTableUpdateState : TableUpdateState {
    common::ValueVector& nodeIDVector;
...
struct LADYBUG_API NodeTableDeleteState : TableDeleteState {
    common::ValueVector& nodeIDVector;
...
class LADYBUG_API NodeTable final : public Table {
public:
