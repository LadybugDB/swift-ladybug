...
struct LADYBUG_API TableScanState {
    Table* table;
...
struct LADYBUG_API TableInsertState {
...
struct LADYBUG_API TableUpdateState {
...
struct LADYBUG_API TableDeleteState {
    bool logToWAL;
