...
static constexpr uint64_t NUM_PAGE_IDXS_PER_PIP =
    (common::LADYBUG_PAGE_SIZE - sizeof(common::page_idx_t)) / sizeof(common::page_idx_t);
...
static_assert(sizeof(PIP) == common::LADYBUG_PAGE_SIZE);
...
template<typename U>
class DiskArray {
    static_assert(sizeof(U) <= common::LADYBUG_PAGE_SIZE);
