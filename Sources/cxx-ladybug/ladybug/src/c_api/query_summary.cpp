...
void ladybug_query_summary_destroy(ladybug_query_summary* query_summary) {
...
double ladybug_query_summary_get_compiling_time(ladybug_query_summary* query_summary) {
    return static_cast<QuerySummary*>(query_summary->_query_summary)->getCompilingTime();
}

double ladybug_query_summary_get_execution_time(ladybug_query_summary* query_summary) {
