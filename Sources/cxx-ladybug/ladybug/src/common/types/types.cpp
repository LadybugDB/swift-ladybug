...
using ladybug::function::BuiltInFunctionsUtils;
...
bool UDTTypeInfo::operator==(const ladybug::common::ExtraTypeInfo& other) const {
...
const LogicalType& ListType::getChildType(const ladybug::common::LogicalType& type) {
...
const LogicalType& StructTypeInfo::getChildType(ladybug::common::struct_field_idx_t idx) const {
...
bool LogicalTypeUtils::isNested(ladybug::common::LogicalTypeID logicalTypeID) {
