...
std::size_t std::hash<ladybug::common::int128_t>::operator()(
    const ladybug::common::int128_t& v) const noexcept {
    ladybug::common::hash_t hash = 0;
    ladybug::function::Hash::operation(v, hash);
    return hash;
}
