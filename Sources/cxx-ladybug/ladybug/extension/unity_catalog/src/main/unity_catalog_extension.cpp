...
#endif
INIT_EXPORT void init(ladybug::main::ClientContext* context) {
    ladybug::unity_catalog_extension::UnityCatalogExtension::load(context);
}

INIT_EXPORT const char* name() {
    return ladybug::unity_catalog_extension::UnityCatalogExtension::EXTENSION_NAME;
}
}
#endif
