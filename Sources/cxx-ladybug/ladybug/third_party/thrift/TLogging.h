...
#ifndef _LADYBUG_THRIFT_TLOGGING_H_
#define _LADYBUG_THRIFT_TLOGGING_H_ 1
 ...
 *                                      printed by calling
 *                                      ladybug_apache::thrift::profile_print_info()
 */
#if T_GLOBAL_DEBUG_VIRTUAL > 1
#define T_VIRTUAL_CALL() ::ladybug_apache::thrift::profile_virtual_call(typeid(*this))
#define T_GENERIC_PROTOCOL(template_class, generic_prot, specific_prot)                            \
  do {                                                                                             \
    if (!(specific_prot)) {                                                                        \
      ::ladybug_apache::thrift::profile_generic_protocol(typeid(*template_class), typeid(*generic_prot));  \
    }                                                                                              \
  } while (0)
...
#endif // #ifndef _LADYBUG_THRIFT_TLOGGING_H_
