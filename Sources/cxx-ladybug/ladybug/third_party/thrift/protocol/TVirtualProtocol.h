...
#ifndef _LADYBUG_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_
#define _LADYBUG_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1
...
using ladybug_apache::thrift::transport::TTransport;
...
public:
  ...
  uint32_t skip(TType type) { return ::ladybug_apache::thrift::protocol::skip(*this, type); }
...
public:
  ...
  uint32_t skip(TType type) {
    ...
    return ::ladybug_apache::thrift::protocol::skip(*prot, type);
  }
...
#endif // #define _LADYBUG_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1
