...
#ifndef _LADYBUG_THRIFT_PROTOCOL_TPROTOCOL_H_
#define _LADYBUG_THRIFT_PROTOCOL_TPROTOCOL_H_ 1
...
namespace ladybug_apache { namespace thrift {
...
}} // namespace ladybug_apache::thrift
...
#endif // #define _LADYBUG_THRIFT_PROTOCOL_TPROTOCOL_H_ 1
