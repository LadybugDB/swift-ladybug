...
#ifndef _LADYBUG_THRIFT_TRANSPORT_TBUFFERTRANSPORTS_H_
#define _LADYBUG_THRIFT_TRANSPORT_TBUFFERTRANSPORTS_H_ 1
...
public:
  ...
  uint32_t readAll(uint8_t* buf, uint32_t len) {
    ...
    return ladybug_apache::thrift::transport::readAll(*this, buf, len);
  }
...
#endif // #ifndef _LADYBUG_THRIFT_TRANSPORT_TBUFFERTRANSPORTS_H_
