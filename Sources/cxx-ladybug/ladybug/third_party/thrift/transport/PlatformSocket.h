...
#ifndef _LADYBUG_THRIFT_TRANSPORT_PLATFORM_SOCKET_H_
#  define _LADYBUG_THRIFT_TRANSPORT_PLATFORM_SOCKET_H_
...
#endif // _LADYBUG_THRIFT_TRANSPORT_PLATFORM_SOCKET_H_
