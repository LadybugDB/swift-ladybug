...
namespace ladybug_parquet { namespace format {
...
uint32_t Statistics::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {

  ::ladybug_apache::thrift::protocol::TInputRecursionTracker tracker(*iprot);
  uint32_t xfer = 0;
  std::string fname;
  ::ladybug_apache::thrift::protocol::TType ftype;
  int16_t fid;

  xfer += iprot->readStructBegin(fname);

  using ::ladybug_apache::thrift::protocol::TProtocolException;


  while (true)
  {
    xfer += iprot->readFieldBegin(fname, ftype, fid);
    if (ftype == ::ladybug_apache::thrift::protocol::T_STOP) {
      break;
    }
    switch (fid)
    {
      case 1:
        if (ftype == ::ladybug_apache::thrift::protocol::T_STRING) {
      ...
      case 2:
        ...
        break;
      case 3:
        if (ftype == ::ladybug_apache::thrift::protocol::T_I64) {
...
uint32_t Statistics::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Statistics");

  if (this->__isset.max) {
    xfer += oprot->writeFieldBegin("max", ::ladybug_apache::thrift::protocol::T_STRING, 1);
    xfer += oprot->writeBinary(this->max);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.min) {
    xfer += oprot->writeFieldBegin("min", ::ladybug_apache::thrift::protocol::T_STRING, 2);
    xfer += oprot->writeBinary(this->min);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.null_count) {
    xfer += oprot->writeFieldBegin("null_count", ::ladybug_apache::thrift::protocol::T_I64, 3);
    xfer += oprot->writeI64(this->null_count);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.distinct_count) {
    xfer += oprot->writeFieldBegin("distinct_count", ::ladybug_apache::thrift::protocol::T_I64, 4);
    xfer += oprot->writeI64(this->distinct_count);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.max_value) {
    xfer += oprot->writeFieldBegin("max_value", ::ladybug_apache::thrift::protocol::T_STRING, 5);
    xfer += oprot->writeBinary(this->max_value);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.min_value) {
    xfer += oprot->writeFieldBegin("min_value", ::ladybug_apache::thrift::protocol::T_STRING, 6);
...
void Statistics::printTo(std::ostream& out) const {
  using ::ladybug_apache::thrift::to_string;
  out << "Statistics(";
...
uint32_t StringType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t StringType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t UUIDType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t UUIDType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t MapType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t MapType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t ListType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t ListType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t EnumType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t EnumType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t DateType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DateType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t NullType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t NullType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t DecimalType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    {
      case 1:
        if (ftype == ::ladybug_apache::thrift::protocol::T_I32) {
...
uint32_t DecimalType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DecimalType");

  xfer += oprot->writeFieldBegin("scale", ::ladybug_apache::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32(this->scale);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("precision", ::ladybug_apache::thrift::protocol::T_I32, 2);
...
uint32_t MilliSeconds::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t MilliSeconds::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t MicroSeconds::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t MicroSeconds::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t NanoSeconds::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t NanoSeconds::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t TimeUnit::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    {
      case 1:
        if (ftype == ::ladybug_apache::thrift::protocol::T_STRUCT) {
...
uint32_t TimeUnit::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TimeUnit");

  if (this->__isset.MILLIS) {
    xfer += oprot->writeFieldBegin("MILLIS", ::ladybug_apache::thrift::protocol::T_STRUCT, 1);
    xfer += this->MILLIS.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.MICROS) {
    xfer += oprot->writeFieldBegin("MICROS", ::ladybug_apache::thrift::protocol::T_STRUCT, 2);
    xfer += this->MICROS.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.NANOS) {
    xfer += oprot->writeFieldBegin("NANOS", ::ladybug_apache::thrift::protocol::T_STRUCT, 3);
...
uint32_t TimestampType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    {
      case 1:
        if (ftype == ::ladybug_apache::thrift::protocol::T_BOOL) {
...
uint32_t TimestampType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TimestampType");

  xfer += oprot->writeFieldBegin("isAdjustedToUTC", ::ladybug_apache::thrift::protocol::T_BOOL, 1);
  xfer += oprot->writeBool(this->isAdjustedToUTC);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("unit", ::ladybug_apache::thrift::protocol::T_STRUCT, 2);
...
uint32_t TimeType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TimeType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t IntType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    {
      case 1:
        if (ftype == ::ladybug_apache::thrift::protocol::T_BYTE) {
...
uint32_t IntType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("IntType");

  xfer += oprot->writeFieldBegin("bitWidth", ::ladybug_apache::thrift::protocol::T_BYTE, 1);
  xfer += oprot->writeByte(this->bitWidth);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("isSigned", ::ladybug_apache::thrift::protocol::T_BOOL, 2);
...
uint32_t JsonType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t JsonType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t BsonType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t BsonType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t LogicalType::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t LogicalType::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("LogicalType");

  if (this->__isset.STRING) {
    xfer += oprot->writeFieldBegin("STRING", ::ladybug_apache::thrift::protocol::T_STRUCT, 1);
    xfer += this->STRING.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.MAP) {
    xfer += oprot->writeFieldBegin("MAP", ::ladybug_apache::thrift::protocol::T_STRUCT, 2);
    xfer += this->MAP.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.LIST) {
    xfer += oprot->writeFieldBegin("LIST", ::ladybug_apache::thrift::protocol::T_STRUCT, 3);
    xfer += this->LIST.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.ENUM) {
    xfer += oprot->writeFieldBegin("ENUM", ::ladybug_apache::thrift::protocol::T_STRUCT, 4);
    xfer += this->ENUM.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.DECIMAL) {
    xfer += oprot->writeFieldBegin("DECIMAL", ::ladybug_apache::thrift::protocol::T_STRUCT, 5);
    xfer += this->DECIMAL.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.DATE) {
    xfer += oprot->writeFieldBegin("DATE", ::ladybug_apache::thrift::protocol::T_STRUCT, 6);
    xfer += this->DATE.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.TIME) {
    xfer += oprot->writeFieldBegin("TIME", ::ladybug_apache::thrift::protocol::T_STRUCT, 7);
    xfer += this->TIME.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.TIMESTAMP) {
    xfer += oprot->writeFieldBegin("TIMESTAMP", ::ladybug_apache::thrift::protocol::T_STRUCT, 8);
    xfer += this->TIMESTAMP.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.INTEGER) {
    xfer += oprot->writeFieldBegin("INTEGER", ::ladybug_apache::thrift::protocol::T_STRUCT, 10);
    xfer += this->INTEGER.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.UNKNOWN) {
    xfer += oprot->writeFieldBegin("UNKNOWN", ::ladybug_apache::thrift::protocol::T_STRUCT, 11);
    xfer += this->UNKNOWN.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.JSON) {
    xfer += oprot->writeFieldBegin("JSON", ::ladybug_apache::thrift::protocol::T_STRUCT, 12);
    xfer += this->JSON.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.BSON) {
    xfer += oprot->writeFieldBegin("BSON", ::ladybug_apache::thrift::protocol::T_STRUCT, 13);
    xfer += this->BSON.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.UUID) {
    xfer += oprot->writeFieldBegin("UUID", ::ladybug_apache::thrift::protocol::T_STRUCT, 14);
...
uint32_t SchemaElement::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SchemaElement::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("SchemaElement");

  if (this->__isset.type) {
    xfer += oprot->writeFieldBegin("type", ::ladybug_apache::thrift::protocol::T_I32, 1);
    xfer += oprot->writeI32((int32_t)this->type);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.type_length) {
    xfer += oprot->writeFieldBegin("type_length", ::ladybug_apache::thrift::protocol::T_I32, 2);
    xfer += oprot->writeI32(this->type_length);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.repetition_type) {
    xfer += oprot->writeFieldBegin("repetition_type", ::ladybug_apache::thrift::protocol::T_I32, 3);
    xfer += oprot->writeI32((int32_t)this->repetition_type);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldBegin("name", ::ladybug_apache::thrift::protocol::T_STRING, 4);
  xfer += oprot->writeString(this->name);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.num_children) {
    xfer += oprot->writeFieldBegin("num_children", ::ladybug_apache::thrift::protocol::T_I32, 5);
    xfer += oprot->writeI32(this->num_children);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.converted_type) {
    xfer += oprot->writeFieldBegin("converted_type", ::ladybug_apache::thrift::protocol::T_I32, 6);
    xfer += oprot->writeI32((int32_t)this->converted_type);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.scale) {
    xfer += oprot->writeFieldBegin("scale", ::ladybug_apache::thrift::protocol::T_I32, 7);
    xfer += oprot->writeI32(this->scale);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.precision) {
    xfer += oprot->writeFieldBegin("precision", ::ladybug_apache::thrift::protocol::T_I32, 8);
    xfer += oprot->writeI32(this->precision);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.field_id) {
    xfer += oprot->writeFieldBegin("field_id", ::ladybug_apache::thrift::protocol::T_I32, 9);
    xfer += oprot->writeI32(this->field_id);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.logicalType) {
    xfer += oprot->writeFieldBegin("logicalType", ::ladybug_apache::thrift::protocol::T_STRUCT, 10);
...
uint32_t DataPageHeader::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DataPageHeader::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DataPageHeader");

  xfer += oprot->writeFieldBegin("num_values", ::ladybug_apache::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32(this->num_values);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("encoding", ::ladybug_apache::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32((int32_t)this->encoding);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("definition_level_encoding", ::ladybug_apache::thrift::protocol::T_I32, 3);
  xfer += oprot->writeI32((int32_t)this->definition_level_encoding);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("repetition_level_encoding", ::ladybug_apache::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32((int32_t)this->repetition_level_encoding);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.statistics) {
    xfer += oprot->writeFieldBegin("statistics", ::ladybug_apache::thrift::protocol::T_STRUCT, 5);
...
uint32_t IndexPageHeader::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t IndexPageHeader::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t DictionaryPageHeader::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DictionaryPageHeader::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  ...
  if (this->__isset.is_sorted) {
    xfer += oprot->writeFieldBegin("is_sorted", ::ladybug_apache::thrift::protocol::T_BOOL, 3);
...
uint32_t DataPageHeaderV2::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DataPageHeaderV2::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  ...
  xfer += oprot->writeFieldBegin("num_nulls", ::ladybug_apache::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32(this->num_nulls);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("num_rows", ::ladybug_apache::thrift::protocol::T_I32, 3);
  xfer += oprot->writeI32(this->num_rows);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("encoding", ::ladybug_apache::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32((int32_t)this->encoding);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("definition_levels_byte_length", ::ladybug_apache::thrift::protocol::T_I32, 5);
  xfer += oprot->writeI32(this->definition_levels_byte_length);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("repetition_levels_byte_length", ::ladybug_apache::thrift::protocol::T_I32, 6);
  xfer += oprot->writeI32(this->repetition_levels_byte_length);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.is_compressed) {
    xfer += oprot->writeFieldBegin("is_compressed", ::ladybug_apache::thrift::protocol::T_BOOL, 7);
    xfer += oprot->writeBool(this->is_compressed);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.statistics) {
    xfer += oprot->writeFieldBegin("statistics", ::ladybug_apache::thrift::protocol::T_STRUCT, 8);
    xfer += this->statistics.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
...
uint32_t PageHeader::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t PageHeader::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  ...
  xfer += oprot->writeFieldBegin("uncompressed_page_size", ::ladybug_apache::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32(this->uncompressed_page_size);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("compressed_page_size", ::ladybug_apache::thrift::protocol::T_I32, 3);
  xfer += oprot->writeI32(this->compressed_page_size);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.crc) {
    xfer += oprot->writeFieldBegin("crc", ::ladybug_apache::thrift::protocol::T_I32, 4);
    xfer += oprot->writeI32(this->crc);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.data_page_header) {
    xfer += oprot->writeFieldBegin("data_page_header", ::ladybug_apache::thrift::protocol::T_STRUCT, 5);
    xfer += this->data_page_header.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.index_page_header) {
    xfer += oprot->writeFieldBegin("index_page_header", ::ladybug_apache::thrift::protocol::T_STRUCT, 6);
    xfer += this->index_page_header.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.dictionary_page_header) {
    xfer += oprot->writeFieldBegin("dictionary_page_header", ::ladybug_apache::thrift::protocol::T_STRUCT, 7);
    xfer += this->dictionary_page_header.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.data_page_header_v2) {
    xfer += oprot->writeFieldBegin("data_page_header_v2", ::ladybug_apache::thrift::protocol::T_STRUCT, 8);
...
uint32_t KeyValue::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t KeyValue::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("KeyValue");

  xfer += oprot->writeFieldBegin("key", ::ladybug_apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->key);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.value) {
    xfer += oprot->writeFieldBegin("value", ::ladybug_apache::thrift::protocol::T_STRING, 2);
...
uint32_t SortingColumn::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SortingColumn::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("SortingColumn");

  xfer += oprot->writeFieldBegin("column_idx", ::ladybug_apache::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32(this->column_idx);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("descending", ::ladybug_apache::thrift::protocol::T_BOOL, 2);
  xfer += oprot->writeBool(this->descending);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("nulls_first", ::ladybug_apache::thrift::protocol::T_BOOL, 3);
...
uint32_t PageEncodingStats::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t PageEncodingStats::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("PageEncodingStats");

  xfer += oprot->writeFieldBegin("page_type", ::ladybug_apache::thrift::protocol::T_I32, 1);
  ...
  xfer += oprot->writeFieldBegin("count", ::ladybug_apache::thrift::protocol::T_I32, 3);
...
uint32_t ColumnMetaData::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
        ...
        break;
      case 2:
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            this->encodings.clear();
            uint32_t _size68;
            ::ladybug_apache::thrift::protocol::TType _etype71;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size74;
            ::ladybug_apache::thrift::protocol::TType _etype77;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size80;
            ::ladybug_apache::thrift::protocol::TType _etype83;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size85;
            ::ladybug_apache::thrift::protocol::TType _etype88;
...
uint32_t ColumnMetaData::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  ...
  xfer += oprot->writeFieldBegin("encodings", ::ladybug_apache::thrift::protocol::T_LIST, 2);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->encodings.size()));
  ...
  xfer += oprot->writeFieldBegin("path_in_schema", ::ladybug_apache::thrift::protocol::T_LIST, 3);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->path_in_schema.size()));
  ...
  xfer += oprot->writeFieldBegin("codec", ::ladybug_apache::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32((int32_t)this->codec);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("num_values", ::ladybug_apache::thrift::protocol::T_I64, 5);
  xfer += oprot->writeI64(this->num_values);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("total_uncompressed_size", ::ladybug_apache::thrift::protocol::T_I64, 6);
  xfer += oprot->writeI64(this->total_uncompressed_size);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("total_compressed_size", ::ladybug_apache::thrift::protocol::T_I64, 7);
  xfer += oprot->writeI64(this->total_compressed_size);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.key_value_metadata) {
    xfer += oprot->writeFieldBegin("key_value_metadata", ::ladybug_apache::thrift::protocol::T_LIST, 8);
    {
      xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->key_value_metadata.size()));
  ...
  xfer += oprot->writeFieldBegin("data_page_offset", ::ladybug_apache::thrift::protocol::T_I64, 9);
  xfer += oprot->writeI64(this->data_page_offset);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.index_page_offset) {
    xfer += oprot->writeFieldBegin("index_page_offset", ::ladybug_apache::thrift::protocol::T_I64, 10);
    xfer += oprot->writeI64(this->index_page_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.dictionary_page_offset) {
    xfer += oprot->writeFieldBegin("dictionary_page_offset", ::ladybug_apache::thrift::protocol::T_I64, 11);
    xfer += oprot->writeI64(this->dictionary_page_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.statistics) {
    xfer += oprot->writeFieldBegin("statistics", ::ladybug_apache::thrift::protocol::T_STRUCT, 12);
    xfer += this->statistics.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.encoding_stats) {
    xfer += oprot->writeFieldBegin("encoding_stats", ::ladybug_apache::thrift::protocol::T_LIST, 13);
    {
      xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->encoding_stats.size()));
...
uint32_t EncryptionWithFooterKey::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t EncryptionWithFooterKey::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t EncryptionWithColumnKey::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            this->path_in_schema.clear();
            uint32_t _size98;
            ::ladybug_apache::thrift::protocol::TType _etype101;
...
uint32_t EncryptionWithColumnKey::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("EncryptionWithColumnKey");

  xfer += oprot->writeFieldBegin("path_in_schema", ::ladybug_apache::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->path_in_schema.size()));
  ...
  if (this->__isset.key_metadata) {
    xfer += oprot->writeFieldBegin("key_metadata", ::ladybug_apache::thrift::protocol::T_STRING, 2);
...
uint32_t ColumnCryptoMetaData::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t ColumnCryptoMetaData::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ColumnCryptoMetaData");

  if (this->__isset.ENCRYPTION_WITH_FOOTER_KEY) {
    xfer += oprot->writeFieldBegin("ENCRYPTION_WITH_FOOTER_KEY", ::ladybug_apache::thrift::protocol::T_STRUCT, 1);
    xfer += this->ENCRYPTION_WITH_FOOTER_KEY.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.ENCRYPTION_WITH_COLUMN_KEY) {
    xfer += oprot->writeFieldBegin("ENCRYPTION_WITH_COLUMN_KEY", ::ladybug_apache::thrift::protocol::T_STRUCT, 2);
...
uint32_t ColumnChunk::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t ColumnChunk::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ColumnChunk");

  if (this->__isset.file_path) {
    xfer += oprot->writeFieldBegin("file_path", ::ladybug_apache::thrift::protocol::T_STRING, 1);
    xfer += oprot->writeString(this->file_path);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldBegin("file_offset", ::ladybug_apache::thrift::protocol::T_I64, 2);
  xfer += oprot->writeI64(this->file_offset);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.meta_data) {
    xfer += oprot->writeFieldBegin("meta_data", ::ladybug_apache::thrift::protocol::T_STRUCT, 3);
    xfer += this->meta_data.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.offset_index_offset) {
    xfer += oprot->writeFieldBegin("offset_index_offset", ::ladybug_apache::thrift::protocol::T_I64, 4);
    xfer += oprot->writeI64(this->offset_index_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.offset_index_length) {
    xfer += oprot->writeFieldBegin("offset_index_length", ::ladybug_apache::thrift::protocol::T_I32, 5);
    xfer += oprot->writeI32(this->offset_index_length);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.column_index_offset) {
    xfer += oprot->writeFieldBegin("column_index_offset", ::ladybug_apache::thrift::protocol::T_I64, 6);
    xfer += oprot->writeI64(this->column_index_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.column_index_length) {
    xfer += oprot->writeFieldBegin("column_index_length", ::ladybug_apache::thrift::protocol::T_I32, 7);
    xfer += oprot->writeI32(this->column_index_length);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.crypto_metadata) {
    xfer += oprot->writeFieldBegin("crypto_metadata", ::ladybug_apache::thrift::protocol::T_STRUCT, 8);
    xfer += this->crypto_metadata.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.encrypted_column_metadata) {
    xfer += oprot->writeFieldBegin("encrypted_column_metadata", ::ladybug_apache::thrift::protocol::T_STRING, 9);
...
uint32_t RowGroup::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            this->columns.clear();
            uint32_t _size110;
            ::ladybug_apache::thrift::protocol::TType _etype113;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size115;
            ::ladybug_apache::thrift::protocol::TType _etype118;
      ...
      case 6:
        ...
        break;
      case 7:
        if (ftype == ::ladybug_apache::thrift::protocol::T_I16) {
...
uint32_t RowGroup::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("RowGroup");

  xfer += oprot->writeFieldBegin("columns", ::ladybug_apache::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->columns.size()));
  ...
  xfer += oprot->writeFieldBegin("total_byte_size", ::ladybug_apache::thrift::protocol::T_I64, 2);
  xfer += oprot->writeI64(this->total_byte_size);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("num_rows", ::ladybug_apache::thrift::protocol::T_I64, 3);
  xfer += oprot->writeI64(this->num_rows);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.sorting_columns) {
    xfer += oprot->writeFieldBegin("sorting_columns", ::ladybug_apache::thrift::protocol::T_LIST, 4);
    {
      xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->sorting_columns.size()));
  ...
  if (this->__isset.file_offset) {
    xfer += oprot->writeFieldBegin("file_offset", ::ladybug_apache::thrift::protocol::T_I64, 5);
    xfer += oprot->writeI64(this->file_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.total_compressed_size) {
    xfer += oprot->writeFieldBegin("total_compressed_size", ::ladybug_apache::thrift::protocol::T_I64, 6);
    xfer += oprot->writeI64(this->total_compressed_size);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.ordinal) {
    xfer += oprot->writeFieldBegin("ordinal", ::ladybug_apache::thrift::protocol::T_I16, 7);
...
uint32_t TypeDefinedOrder::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TypeDefinedOrder::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t ColumnOrder::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t ColumnOrder::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ColumnOrder");

  if (this->__isset.TYPE_ORDER) {
    xfer += oprot->writeFieldBegin("TYPE_ORDER", ::ladybug_apache::thrift::protocol::T_STRUCT, 1);
...
uint32_t PageLocation::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t PageLocation::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("PageLocation");

  xfer += oprot->writeFieldBegin("offset", ::ladybug_apache::thrift::protocol::T_I64, 1);
  xfer += oprot->writeI64(this->offset);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("compressed_page_size", ::ladybug_apache::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32(this->compressed_page_size);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("first_row_index", ::ladybug_apache::thrift::protocol::T_I64, 3);
...
uint32_t OffsetIndex::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size130;
            ::ladybug_apache::thrift::protocol::TType _etype133;
...
uint32_t OffsetIndex::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("OffsetIndex");

  xfer += oprot->writeFieldBegin("page_locations", ::ladybug_apache::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->page_locations.size()));
...
uint32_t ColumnIndex::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size138;
            ::ladybug_apache::thrift::protocol::TType _etype141;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size143;
            ::ladybug_apache::thrift::protocol::TType _etype146;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size148;
            ::ladybug_apache::thrift::protocol::TType _etype151;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size154;
            ::ladybug_apache::thrift::protocol::TType _etype157;
...
uint32_t ColumnIndex::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ColumnIndex");

  xfer += oprot->writeFieldBegin("null_pages", ::ladybug_apache::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_BOOL, static_cast<uint32_t>(this->null_pages.size()));
  ...
  xfer += oprot->writeFieldBegin("min_values", ::ladybug_apache::thrift::protocol::T_LIST, 2);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->min_values.size()));
  ...
  xfer += oprot->writeFieldBegin("max_values", ::ladybug_apache::thrift::protocol::T_LIST, 3);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->max_values.size()));
  ...
  xfer += oprot->writeFieldBegin("boundary_order", ::ladybug_apache::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32((int32_t)this->boundary_order);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.null_counts) {
    xfer += oprot->writeFieldBegin("null_counts", ::ladybug_apache::thrift::protocol::T_LIST, 5);
    {
      xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_I64, static_cast<uint32_t>(this->null_counts.size()));
...
uint32_t AesGcmV1::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t AesGcmV1::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("AesGcmV1");

  if (this->__isset.aad_prefix) {
    xfer += oprot->writeFieldBegin("aad_prefix", ::ladybug_apache::thrift::protocol::T_STRING, 1);
    xfer += oprot->writeBinary(this->aad_prefix);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.aad_file_unique) {
    xfer += oprot->writeFieldBegin("aad_file_unique", ::ladybug_apache::thrift::protocol::T_STRING, 2);
    xfer += oprot->writeBinary(this->aad_file_unique);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.supply_aad_prefix) {
    xfer += oprot->writeFieldBegin("supply_aad_prefix", ::ladybug_apache::thrift::protocol::T_BOOL, 3);
...
uint32_t AesGcmCtrV1::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t AesGcmCtrV1::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t EncryptionAlgorithm::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t EncryptionAlgorithm::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("EncryptionAlgorithm");

  if (this->__isset.AES_GCM_V1) {
    xfer += oprot->writeFieldBegin("AES_GCM_V1", ::ladybug_apache::thrift::protocol::T_STRUCT, 1);
    xfer += this->AES_GCM_V1.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.AES_GCM_CTR_V1) {
    xfer += oprot->writeFieldBegin("AES_GCM_CTR_V1", ::ladybug_apache::thrift::protocol::T_STRUCT, 2);
...
uint32_t FileMetaData::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            this->schema.clear();
            uint32_t _size171;
            ::ladybug_apache::thrift::protocol::TType _etype174;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size176;
            ::ladybug_apache::thrift::protocol::TType _etype179;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            this->key_value_metadata.clear();
            uint32_t _size181;
            ::ladybug_apache::thrift::protocol::TType _etype184;
        ...
        if (ftype == ::ladybug_apache::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size186;
            ::ladybug_apache::thrift::protocol::TType _etype189;
...
uint32_t FileMetaData::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("FileMetaData");

  xfer += oprot->writeFieldBegin("version", ::ladybug_apache::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32(this->version);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("schema", ::ladybug_apache::thrift::protocol::T_LIST, 2);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->schema.size()));
  ...
  xfer += oprot->writeFieldBegin("row_groups", ::ladybug_apache::thrift::protocol::T_LIST, 4);
  {
    xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->row_groups.size()));
  ...
  if (this->__isset.key_value_metadata) {
    xfer += oprot->writeFieldBegin("key_value_metadata", ::ladybug_apache::thrift::protocol::T_LIST, 5);
    {
      xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->key_value_metadata.size()));
  ...
  if (this->__isset.created_by) {
    xfer += oprot->writeFieldBegin("created_by", ::ladybug_apache::thrift::protocol::T_STRING, 6);
    xfer += oprot->writeString(this->created_by);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.column_orders) {
    xfer += oprot->writeFieldBegin("column_orders", ::ladybug_apache::thrift::protocol::T_LIST, 7);
    {
      xfer += oprot->writeListBegin(::ladybug_apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->column_orders.size()));
  ...
  if (this->__isset.encryption_algorithm) {
    xfer += oprot->writeFieldBegin("encryption_algorithm", ::ladybug_apache::thrift::protocol::T_STRUCT, 8);
    xfer += this->encryption_algorithm.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.footer_signing_key_metadata) {
    xfer += oprot->writeFieldBegin("footer_signing_key_metadata", ::ladybug_apache::thrift::protocol::T_STRING, 9);
...
uint32_t FileCryptoMetaData::read(::ladybug_apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t FileCryptoMetaData::write(::ladybug_apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::ladybug_apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("FileCryptoMetaData");

  xfer += oprot->writeFieldBegin("encryption_algorithm", ::ladybug_apache::thrift::protocol::T_STRUCT, 1);
  xfer += this->encryption_algorithm.write(oprot);
  xfer += oprot->writeFieldEnd();
