...
ladybug_value* ladybug_value_create_null() {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(Value::createNullValue());
    return c_value;
}

ladybug_value* ladybug_value_create_null_with_data_type(ladybug_logical_type* data_type) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value =
...
bool ladybug_value_is_null(ladybug_value* value) {
    return static_cast<Value*>(value->_value)->isNull();
}

void ladybug_value_set_null(ladybug_value* value, bool is_null) {
    static_cast<Value*>(value->_value)->setNull(is_null);
}

ladybug_value* ladybug_value_create_default(ladybug_logical_type* data_type) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value =
...
ladybug_value* ladybug_value_create_bool(bool val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_int8(int8_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_int16(int16_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_int32(int32_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_int64(int64_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_uint8(uint8_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_uint16(uint16_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_uint32(uint32_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_uint64(uint64_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_int128(ladybug_int128_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
...
ladybug_value* ladybug_value_create_float(float val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_double(double val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}

ladybug_value* ladybug_value_create_internal_id(ladybug_internal_id_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
...
ladybug_value* ladybug_value_create_date(ladybug_date_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
...
ladybug_value* ladybug_value_create_timestamp_ns(ladybug_timestamp_ns_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
...
ladybug_value* ladybug_value_create_timestamp_ms(ladybug_timestamp_ms_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
...
ladybug_value* ladybug_value_create_timestamp_sec(ladybug_timestamp_sec_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
...
ladybug_value* ladybug_value_create_timestamp_tz(ladybug_timestamp_tz_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
...
ladybug_value* ladybug_value_create_timestamp(ladybug_timestamp_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
...
ladybug_value* ladybug_value_create_interval(ladybug_interval_t val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
...
ladybug_value* ladybug_value_create_string(const char* val_) {
    auto* c_value = (ladybug_value*)calloc(1, sizeof(ladybug_value));
    c_value->_value = new Value(val_);
    return c_value;
}
...
void ladybug_value_copy(ladybug_value* value, ladybug_value* other) {
    static_cast<Value*>(value->_value)->copyValueFrom(*static_cast<Value*>(other->_value));
}

void ladybug_value_destroy(ladybug_value* value) {
    if (value == nullptr) {
        return;
    }
...
ladybug_state ladybug_value_get_struct_field_value(ladybug_value* value, uint64_t index,
    ladybug_value* out_value) {
    return ladybug_value_get_list_element(value, index, out_value);
}
...
ladybug_state ladybug_int128_t_from_string(const char* str, ladybug_int128_t* out_result) {
    ...
    try {
        ladybug::function::CastString::operation(ku_string_t{str, strlen(str)}, int128_val);
        out_result->low = int128_val.low;
        out_result->high = int128_val.high;
...
void ladybug_destroy_blob(uint8_t* blob) {
    free(blob);
}

ladybug_state ladybug_timestamp_ns_to_tm(ladybug_timestamp_ns_t timestamp, struct tm* out_result) {
...
void ladybug_interval_from_difftime(double difftime, ladybug_interval_t* out_result) {
