...
#define KU_ASSERT_UNCONDITIONAL(condition)                                                         \
    static_cast<bool>(condition) ?                                                                 \
        void(0) :                                                                                  \
        ladybug::common::kuAssertFailureInternal(#condition, __FILE__, __LINE__)

#if defined(LADYBUG_RUNTIME_CHECKS) || !defined(NDEBUG)
...
#define KU_UNREACHABLE                                                                             \
    /* LCOV_EXCL_START */ [[unlikely]] ladybug::common::kuAssertFailureInternal("KU_UNREACHABLE",     \
