...
public:
     ...
     */
    LADYBUG_API static Value createNullValue();
    /**
     * @param dataType the type of the NULL value.
     * @return a NULL value of the given type.
     */
    LADYBUG_API static Value createNullValue(const LogicalType& dataType);
    /**
     * @param dataType the type of the non-NULL value.
     * @return a default non-NULL value of the given type.
     */
    LADYBUG_API static Value createDefaultValue(const LogicalType& dataType);
    /**
     * @param val_ the boolean value to set.
     */
    LADYBUG_API explicit Value(bool val_);
    /**
     * @param val_ the int8_t value to set.
     */
    LADYBUG_API explicit Value(int8_t val_);
    /**
     * @param val_ the int16_t value to set.
     */
    LADYBUG_API explicit Value(int16_t val_);
    /**
     * @param val_ the int32_t value to set.
     */
    LADYBUG_API explicit Value(int32_t val_);
    /**
     * @param val_ the int64_t value to set.
     */
    LADYBUG_API explicit Value(int64_t val_);
    /**
     * @param val_ the uint8_t value to set.
     */
    LADYBUG_API explicit Value(uint8_t val_);
    /**
     * @param val_ the uint16_t value to set.
     */
    LADYBUG_API explicit Value(uint16_t val_);
    /**
     * @param val_ the uint32_t value to set.
     */
    LADYBUG_API explicit Value(uint32_t val_);
    /**
     * @param val_ the uint64_t value to set.
     */
    LADYBUG_API explicit Value(uint64_t val_);
    /**
     * @param val_ the int128_t value to set.
     */
    LADYBUG_API explicit Value(int128_t val_);
    /**
     * @param val_ the UUID value to set.
     */
    LADYBUG_API explicit Value(ku_uuid_t val_);
    /**
     * @param val_ the double value to set.
     */
    LADYBUG_API explicit Value(double val_);
    /**
     * @param val_ the float value to set.
     */
    LADYBUG_API explicit Value(float val_);
    /**
     * @param val_ the date value to set.
     */
    LADYBUG_API explicit Value(date_t val_);
    /**
     * @param val_ the timestamp_ns value to set.
     */
    LADYBUG_API explicit Value(timestamp_ns_t val_);
    /**
     * @param val_ the timestamp_ms value to set.
     */
    LADYBUG_API explicit Value(timestamp_ms_t val_);
    /**
     * @param val_ the timestamp_sec value to set.
     */
    LADYBUG_API explicit Value(timestamp_sec_t val_);
    /**
     * @param val_ the timestamp_tz value to set.
     */
    LADYBUG_API explicit Value(timestamp_tz_t val_);
    /**
     * @param val_ the timestamp value to set.
     */
    LADYBUG_API explicit Value(timestamp_t val_);
    /**
     * @param val_ the interval value to set.
     */
    LADYBUG_API explicit Value(interval_t val_);
    /**
     * @param val_ the internalID value to set.
     */
    LADYBUG_API explicit Value(internalID_t val_);
    /**
     * @param val_ the string value to set.
     */
    LADYBUG_API explicit Value(const char* val_);
    /**
     * @param val_ the string value to set.
     */
    LADYBUG_API explicit Value(const std::string& val_);
    /**
     * @param val_ the uint8_t* value to set.
     */
    LADYBUG_API explicit Value(uint8_t* val_);
     ...
     * @param val_ the string value to set.
     */
    LADYBUG_API explicit Value(LogicalType type, std::string val_);
    /**
     * @param dataType the logical type of the value.
     * @param children a vector of children values.
     */
    LADYBUG_API explicit Value(LogicalType dataType, std::vector<std::unique_ptr<Value>> children);
    /**
     * @param other the value to copy from.
     */
    LADYBUG_API Value(const Value& other);

    /**
     * @param other the value to move from.
     */
    LADYBUG_API Value(Value&& other) = default;
    LADYBUG_API Value& operator=(Value&& other) = default;
    LADYBUG_API bool operator==(const Value& rhs) const;

    /**
     * @brief Sets the data type of the Value.
     * @param dataType_ the data type to set to.
     */
    LADYBUG_API void setDataType(const LogicalType& dataType_);
    /**
     * @return the dataType of the value.
     */
    LADYBUG_API const LogicalType& getDataType() const;
    /**
     * @brief Sets the null flag of the Value.
     * @param flag null value flag to set.
     */
    LADYBUG_API void setNull(bool flag);
    /**
     * @brief Sets the null flag of the Value to true.
     */
    LADYBUG_API void setNull();
    /**
     * @return whether the Value is null or not.
     */
    LADYBUG_API bool isNull() const;
    /**
     * @brief Copies from the row layout value.
     * @param value value to copy from.
     */
    LADYBUG_API void copyFromRowLayout(const uint8_t* value);
    /**
     * @brief Copies from the col layout value.
     * @param value value to copy from.
     */
    LADYBUG_API void copyFromColLayout(const uint8_t* value, ValueVector* vec = nullptr);
    /**
     * @brief Copies from the other.
     * @param other value to copy from.
     */
    LADYBUG_API void copyValueFrom(const Value& other);
    /**
     ...
     */
    LADYBUG_API std::unique_ptr<Value> copy() const;
    /**
     * @return the current value in string format.
     */
    LADYBUG_API std::string toString() const;

    LADYBUG_API void serialize(Serializer& serializer) const;

    LADYBUG_API static std::unique_ptr<Value> deserialize(Deserializer& deserializer);

    LADYBUG_API void validateType(common::LogicalTypeID targetTypeID) const;
    ...
    LADYBUG_API uint32_t getChildrenSize() const { return childrenSize; }
 ...
 */
template<>
LADYBUG_API inline bool Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline int8_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline int16_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline int32_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline int64_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline uint64_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline uint32_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline uint16_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline uint8_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline int128_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline float Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline double Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline date_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline timestamp_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline timestamp_ns_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline timestamp_ms_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline timestamp_sec_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline timestamp_tz_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline interval_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline internalID_t Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline std::string Value::getValue() const {
 ...
 */
template<>
LADYBUG_API inline bool& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::BOOL);
    return val.booleanVal;
}
 ...
 */
template<>
LADYBUG_API inline int8_t& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::INT8);
    return val.int8Val;
}
 ...
 */
template<>
LADYBUG_API inline int16_t& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::INT16);
    return val.int16Val;
}
 ...
 */
template<>
LADYBUG_API inline int32_t& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::INT32);
    return val.int32Val;
}
 ...
 */
template<>
LADYBUG_API inline int64_t& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::INT64);
    return val.int64Val;
}
 ...
 */
template<>
LADYBUG_API inline uint8_t& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::UINT8);
    return val.uint8Val;
}
 ...
 */
template<>
LADYBUG_API inline uint16_t& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::UINT16);
    return val.uint16Val;
}
 ...
 */
template<>
LADYBUG_API inline uint32_t& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::UINT32);
    return val.uint32Val;
}
 ...
 */
template<>
LADYBUG_API inline uint64_t& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::UINT64);
    return val.uint64Val;
}
 ...
 */
template<>
LADYBUG_API inline int128_t& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::INT128);
    return val.int128Val;
}
 ...
 */
template<>
LADYBUG_API inline float& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::FLOAT);
    return val.floatVal;
}
 ...
 */
template<>
LADYBUG_API inline double& Value::getValueReference() {
    KU_ASSERT(dataType.getPhysicalType() == PhysicalTypeID::DOUBLE);
    return val.doubleVal;
}
 ...
 */
template<>
LADYBUG_API inline date_t& Value::getValueReference() {
    KU_ASSERT(dataType.getLogicalTypeID() == LogicalTypeID::DATE);
 ...
 */
template<>
LADYBUG_API inline timestamp_t& Value::getValueReference() {
    KU_ASSERT(dataType.getLogicalTypeID() == LogicalTypeID::TIMESTAMP);
 ...
 */
template<>
LADYBUG_API inline timestamp_ms_t& Value::getValueReference() {
    KU_ASSERT(dataType.getLogicalTypeID() == LogicalTypeID::TIMESTAMP_MS);
 ...
 */
template<>
LADYBUG_API inline timestamp_ns_t& Value::getValueReference() {
    KU_ASSERT(dataType.getLogicalTypeID() == LogicalTypeID::TIMESTAMP_NS);
 ...
 */
template<>
LADYBUG_API inline timestamp_sec_t& Value::getValueReference() {
    KU_ASSERT(dataType.getLogicalTypeID() == LogicalTypeID::TIMESTAMP_SEC);
 ...
 */
template<>
LADYBUG_API inline timestamp_tz_t& Value::getValueReference() {
    KU_ASSERT(dataType.getLogicalTypeID() == LogicalTypeID::TIMESTAMP_TZ);
 ...
 */
template<>
LADYBUG_API inline interval_t& Value::getValueReference() {
    KU_ASSERT(dataType.getLogicalTypeID() == LogicalTypeID::INTERVAL);
    return val.intervalVal;
}
 ...
 */
template<>
LADYBUG_API inline nodeID_t& Value::getValueReference() {
    KU_ASSERT(dataType.getLogicalTypeID() == LogicalTypeID::INTERNAL_ID);
    return val.internalIDVal;
}
 ...
 */
template<>
LADYBUG_API inline std::string& Value::getValueReference() {
    KU_ASSERT(dataType.getLogicalTypeID() == LogicalTypeID::STRING);
    return strVal;
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(bool val) {
    return Value(val);
}

template<>
LADYBUG_API inline Value Value::createValue(int8_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(int16_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(int32_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(int64_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(uint8_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(uint16_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(uint32_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(uint64_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(int128_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(double val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(date_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(timestamp_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(interval_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(nodeID_t val) {
    return Value(val);
}
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(std::string val) {
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(const char* value) {
 ...
 */
template<>
LADYBUG_API inline Value Value::createValue(ku_uuid_t val) {
    return Value(val);
}
