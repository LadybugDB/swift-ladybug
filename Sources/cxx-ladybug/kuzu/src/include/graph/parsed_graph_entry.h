...
struct LADYBUG_API ParsedGraphEntry {
    GraphEntryType type;
...
struct LADYBUG_API ParsedNativeGraphEntry : ParsedGraphEntry {
...
struct LADYBUG_API ParsedCypherGraphEntry : ParsedGraphEntry {
