...
struct LADYBUG_API RelTableInsertState : TableInsertState {
...
struct LADYBUG_API RelTableDeleteState final : TableDeleteState {
    common::ValueVector& srcNodeIDVector;
    common::ValueVector& dstNodeIDVector;
    common::ValueVector& relIDVector;
...
class LADYBUG_API RelTable final : public Table {
public:
