...
private:
    ...
    ladybug::regex::Regexp* entire_regexp_; // parsed regular expression
    ladybug::regex::Regexp* suffix_regexp_; // parsed regular expression, prefix_ removed
...
using ladybug::regex::LazyRE2;
using ladybug::regex::RE2;
