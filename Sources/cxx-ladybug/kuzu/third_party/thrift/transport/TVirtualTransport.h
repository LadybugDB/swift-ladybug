...
#ifndef _LADYBUG_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_
#define _LADYBUG_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_ 1
...
public:
  ...
  uint32_t readAll(uint8_t* buf, uint32_t len) {
    ...
    return ::ladybug_apache::thrift::transport::readAll(*trans, buf, len);
  }
...
#endif // #ifndef _LADYBUG_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_
