...
#ifndef _LADYBUG_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
#define _LADYBUG_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_ 1
 ...
 *
 */
class TProtocolException : public ladybug_apache::thrift::TException {
public:
  /**
  ...
  TProtocolException() : ladybug_apache::thrift::TException(), type_(UNKNOWN) {}

  TProtocolException(TProtocolExceptionType type) : ladybug_apache::thrift::TException(), type_(type) {}
...
#endif // #ifndef _LADYBUG_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
